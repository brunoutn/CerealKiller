...
SubAlgoritmo Jugar
	...
	Repetir
        ...
        Segun opPrinc
            ...
            De Otro Modo:
				Limpiar Pantalla
                Escribir "Opci贸n inv谩lida, intente de nuevo."
        FinSegun
...
// Funci贸n para darle posici贸n inicial al asesino
...
//Funcion para evaluar que el detective no est茅 en medio del camino
Funcion evaluacion <- EvaluarDetectiveEnCamino(posAsesino, posDetective, posCasa, movimientosRestantes)
	...
	// Verificar si a煤n tiene movimientos y puede continuar hacia la fila
	...
	// Si la primera fase fall贸, intentar la segunda
	Si evaluacion = Falso Entonces
		movimientosRestantes = 3
		asesino_temp[0] = posAsesino[0] // Reiniciar la posici贸n temporal del asesino
		...
		// Verificar si a煤n tiene movimientos y puede continuar hacia la columna
		Si movimientosRestantes > 0 Entonces
			Mientras movimientosRestantes > 0 y asesino_temp[1] <> posCasa[1] Hacer
				Si asesino_temp[1] < posCasa[1] Entonces
					asesino_temp[1] = asesino_temp[1] + 1 // Mover a la derecha
...
SubAlgoritmo ubicarJugadorEnTablero(tablero, casillaAnterior Por Referencia, posDetective)
    ...
    // Colocar al jugador "D" en la nueva posici髇
    ...
    Para i = 0 Hasta 4-1 Con Paso 1
        Para j = 0 Hasta 5-1 Con Paso 1
            Si tablero[i, j] = "D" Entonces
                tablero[i, j] = casillaAnterior  // Restauramos el valor que hab韆 antes de colocar el jugador
				i = 3
				j = 4
            FinSi
        FinPara
    FinPara
    // Guardar lo que hab韆 en la nueva posici髇 antes de colocar al jugador
...
/// Funci贸n para dar un numero de casilla segun fila y columna
	...
	Para i Desde 0 Hasta 1 Hacer
		Para j Desde 0 Hasta 1 Hacer
			Si (Abs(i) <> Abs(j)) Entonces
				...
				// Validar que est茅 dentro del rango del tablero
...
SubAlgoritmo MostrarReglas
    ...
    Escribir "*                                                                                                                                              - El Asesino debe eliminar 6 v铆ctimas sin ser capturado.                                                                                                                                                          *"
    Escribir "*                                                                                                                                                                                                                                                                                                                                                                *"
    ...
    Escribir "*                                                                                                                                                * Elige un caf茅 para iniciar.                                                                                                                                                                                   *"
    Escribir "*                                                                                                                                                * En el dia 2,4 y 6 recibe pistas de los testigos sobre la ubicacion del asesino.                                                                                                                               *"
    Escribir "*                                                                                                                                                                                                                                                                                                                                                                *"
    ...
    Escribir "*                                                                                                                                              - Gana el Asesino si logra 6 v铆ctimas o el Detective se queda sin intentos.                                                                                                                                       *"
