	...
	Para i Desde 0 Hasta 1 Hacer
		Para j Desde 0 Hasta 1 Hacer
			Si (Abs(i) <> Abs(j)) Entonces // Evita diagonales
				...
				// Validar que esté dentro del rango del tablero (4x5)
...
////SUMAR TESTIGO
//- En el caso de que el detective comience, pase o termine su turno en el mismo o un casillero adyacente a un testigo, se le interrogará automáticamente, desplegando un menú de preguntas:
//	- 1. ¿En qué dirección está el Asesino? (Arriba/Abajo/Izquierda/Derecha)
//	- 2. ¿El Asesino está en la misma fila que el Testigo? (Si/No)
//		- 3. ¿El Asesino está en la misma columna que el Testigo? (Si/No)
//			- 4. ¿El Asesino está en una casa, parque o café? (Si/No) - 5. ¿El Asesino está en un casillero Par o Impar? (Par/Impar)
